...
public class main {
	...
	public Integer getDay_race_num() {
		return day_race_num;
	}
	public void setDay_race_num(Integer day_race_num) {
		this.day_race_num = day_race_num;
	}
	...
	public void setThousandfivehundred_time(String thousandfivehundred_time) {
		this.thousandfivehundred_time = thousandfivehundred_time;
	}
