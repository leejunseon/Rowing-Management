...
<link type="text/css" rel="stylesheet" href="http://13.209.161.83:8080/rowing/resources/css/rowingAddRaceSchedule.css?asdf">
...
<link type="text/css" rel="stylesheet" href="http://localhost:8080/rowing/resources/css/rowingAddRaceSchedule.css?xcvwef">
...
function addrace(){
	...
	var url = 'http://13.209.161.83:8080/rowing/main/addRace';
	console.log("addUser")
	$.ajax({
		url:url,
		type : 'GET',
