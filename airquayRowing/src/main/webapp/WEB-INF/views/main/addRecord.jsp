...
<link type="text/css" rel="stylesheet" href="http://localhost:8080/airquayRowing/resources/css/rowingAddrace.css?ver=3">
...
<script src="https://code.jquery.com/jquery-3.0.0.min.js?ver=3"></script>
